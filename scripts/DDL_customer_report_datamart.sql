...
CREATE TABLE IF NOT EXISTS dwh.customer_report_datamart (
    ...
    platform_money NUMERIC(10,2) NOT NULL, -- сумма денег, которая заработала платформа от покупок заказчика за месяц (10% от суммы, которую потратил заказчик)
...
-- Создаем таблицу с датой загрузки данных в витрину
